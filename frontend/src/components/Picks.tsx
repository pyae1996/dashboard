      ...
      <div>
        ...
        <ResponsiveContainer width="100%" height="100%">
            ...
            >
              ...
              <XAxis dataKey="date" />
              <YAxis interval="preserveStartEnd" domain={[picksData.min_accumulated_picks,picksData.max_accumulated_picks]}/>
              
              <Area
              name="Accumulating Total Picks"
                type="monotone"
                dataKey="accumulated_picks"
                fill="#8884d8"
                stroke="#8884d8"
              />
              <Bar name="Total Picks" dataKey="total_picks" barSize={20} fill="#413ea0" />
  ...
  if (active && payload && payload.length) {
    return (
      <div className="bg-white p-2 border border-gray-200 shadow rounded">
        ...
        <p>Accumulating Total Picks: {payload[0].payload.accumulated_picks}</p>
